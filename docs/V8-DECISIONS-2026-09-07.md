...
## 2026-09-07 approved addendum - contract 3.1.1

### D-C-40 - travel selection refresh

Operator-approved V8-R-NXT-008: Walkable, Worth a cab and Anywhere recompute the selected search; stale responses cannot overwrite it. See V8-PRD-DELTA-2026-09-07.md for acceptance criteria.

### D-C-41 - explicit vibe eligibility and honest badge

Operator-approved V8-R-NXT-009: no explicit selection means no badge; N selections show matches/N and require at least max(1,N-1) matches. No fallback may admit bars missing two or more choices. Overrides nonmatching fill and five-result padding only for explicit selections. Earlier approved contracts otherwise remain in force.
