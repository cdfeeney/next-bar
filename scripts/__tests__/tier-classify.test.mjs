...
/**
 * The behaviour a case table cannot express, because it is about what a CHANGE
 * did rather than what one file contains. Each spawns real
 ...
 */
describe('entry points agree on a deleted-then-recreated path', () => {
