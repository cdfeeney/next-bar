 ...
 * src/lib/intent.ts), so "Maya is going out tonight" is no longer true
 ...
 * (Maya out, Jordan on the fence, Sasha already there); midweek is
...
> = {
  ...
  maya:   [  null,    null,   'maybe',  null,   'going', 'going',  null  ],
  jordan: [  null,   'maybe',  null,   'going',  null,   'maybe', 'here' ],
