...
const coreBars: Bar[] = [
  ...
  },
  {
    ...
    lng: -74.0050252,
    priceTier: 3,
    tags: ['speakeasy', 'cocktail', 'jazz', 'date', 'pricey', 'lounge', 'romantic'],
  ...
  // ---- Chelsea (5) ----
  {
    ...
    lng: -74.0031429,
    priceTier: 3,
    tags: ['speakeasy', 'cocktail', 'polished', 'date', 'pricey', 'live', 'loud'],
  ...
  // ---- FiDi (5) ----
  {
    ...
    lng: -74.0110157,
    priceTier: 3,
    tags: ['cocktail', 'pub', 'polished', 'industry', 'pricey', 'live', 'buzzy'],
  ...
  // ---- Midtown (5) ----
  {
    ...
    lng: -73.9778482,
    priceTier: 3,
    tags: ['cocktail', 'polished', 'post-work', 'pricey', 'old-nyc', 'instagrammable'],
  ...
  },
  {
    ...
    lng: -73.9707825,
    priceTier: 1,
    tags: ['dive', 'cheap', 'locals', 'pub', 'beer', 'buzzy'],
  ...
  },
  {
    ...
    lng: -73.9773296,
    priceTier: 2,
    tags: ['pub', 'locals', 'old-nyc', 'beer', 'mid', 'chill'],
  ...
  },
  {
    ...
    lng: -73.9530954,
    priceTier: 2,
    tags: ['pub', 'mid', 'buzzy', 'post-work', 'beer', 'locals', 'date'],
