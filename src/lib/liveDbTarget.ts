...
// SINGLE DEVIATION FROM THE BYTE-IDENTICAL IMPORT: checkConnectionEndpoint moved into the shared
// guard on 2026-08-29 so every entry point reaches it, and was deleted from the old layer.
