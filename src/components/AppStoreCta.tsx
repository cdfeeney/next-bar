...
const SUBHEADS: Record<NonNullable<AppStoreCtaProps['variant']>, string> = {
  ...
  // Signed-in Beta data is account-backed; anonymous use stays local-first.
  tried:
    'Install Next Bar on your home screen to keep your nightlife close. Sign in and your ratings, lists, and night history sync across devices.',
};
