...
const AUDIENCE_ROWS: ReadonlyArray<{
  ...
  },
  {
    ...
    hint: 'LES Crew, Friday Night, Coworkers',
  },
  { value: 'custom', label: 'Custom', hint: 'Pick people and groups' },
];
  ...
  return (
    <Sheet label="Story audience" testId="story-audience-sheet" onClose={onClose}>
      ...
      <button
        ...
        onClick={onDone}
        className="w-full min-h-[52px] mt-5 rounded-2xl bg-accent text-bg font-display text-sm uppercase tracking-widest touch-manipulation hover:bg-accentDim transition-colors"
      >
        Done
      </button>
