  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* google-live deliberately renders NO media here (santa BLOCK,
            2026-08-06): ResultCard's widget is the app's ONLY billable
            Google surface, and it already carries lightbox-preferred —
            Google's own lightbox handles photo expansion. This dialog is
            the hours/details/actions surface and must issue zero Google
            widget requests; a second widget per bar would double the bill
